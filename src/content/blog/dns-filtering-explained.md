...
/\* ── Layout ─────────────────────────────────────── \*/ .post-layout { display: grid; grid-template-columns: 240px 1fr; gap: 48px; align-items: start; } .post-toc { position: sticky; top: 88px; max-height: calc(100vh - 120px); overflow: auto; padding-right: 8px; } .toc-box { background: var(--panel); border: 1px solid var(--line); border-top: 3px solid var(--accent); border-radius: var(--r-lg); padding: 24px 20px; box-shadow: 0 12px 24px rgba(0,0,0,0.06); } .post-toc h4 { font-size: 12px; text-transform: uppercase; letter-spacing: .1em; color: var(--muted); margin: 0 0 12px; } .post-toc ul { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 6px; } .post-toc a { display: block; font-size: 13px; color: var(--text-2); padding: 5px 10px; border-radius: 6px; border-left: 2px solid transparent; transition: color .15s, background .15s, border-color .15s; } .post-toc a:hover, .post-toc a.active { color: var(--accent); background: var(--bg-2); border-left-color: var(--accent); } @media (max-width:1000px) { .post-layout { grid-template-columns: minmax(0,1fr); } .post-toc { display: none; } } /\* ── Section base ───────────────────────────────── \*/ .post-section { position: relative; margin-bottom: 64px; padding-top: 8px; scroll-margin-top: 92px; } .section-num { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 50%; background: var(--accent); color: #fff; font-family: var(--mono); font-size: 11px; font-weight: 700; letter-spacing: .02em; margin-bottom: 14px; } /\* ── TL;DR + Key Takeaways ──────────────────────── \*/ .post-tldr { background: linear-gradient(135deg, var(--accent-soft) 0%, rgba(218,41,28,.03) 100%); border: 1px solid var(--accent-line); border-radius: var(--r-lg); padding: 28px; margin-bottom: 32px; } .tldr-head { display: flex; align-items: center; gap: 12px; margin-bottom: 14px; flex-wrap: wrap; } .tldr-label { font-family: var(--mono); font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; background: var(--accent); color: #fff; padding: 5px 12px; border-radius: 999px; } .post-tldr h3 { font-size: 20px; margin: 0; color: var(--text); } .tldr-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 10px; } .tldr-list li { display: flex; gap: 12px; align-items: flex-start; font-size: 15px; line-height: 1.55; color: var(--text-2); } .tldr-list .ck { width: 20px; height: 20px; border-radius: 50%; background: var(--accent); color: #fff; display: grid; place-items: center; font-size: 11px; flex: none; margin-top: 2px; } .what-found { background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-lg); padding: 26px; margin: 0 0 48px; box-shadow: var(--shadow); } .what-found-head { display: flex; align-items: center; gap: 10px; margin-bottom: 14px; } /\* ── FAQ ────────────────────────────────────────── \*/ .faq-box { background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-lg); padding: 32px; box-shadow: var(--shadow); margin: 48px 0; } .faq-item { border-bottom: 1px solid var(--line); padding: 16px 0; } .faq-item:last-child { border-bottom: none; } .faq-summary { font-size: 16px; font-weight: 600; cursor: pointer; list-style: none; display: flex; justify-content: space-between; align-items: center; color: var(--text); margin: 0; padding-right: 16px; } .faq-summary::-webkit-details-marker { display: none; } .faq-summary::after { content: '+'; font-size: 24px; line-height: 1; color: var(--accent); font-weight: 400; } details\[open\] .faq-summary::after { content: '−'; } .faq-answer { font-size: 15px; line-height: 1.6; color: var(--text-2); margin-top: 12px; margin-bottom: 0; padding-right: 24px; } .faq-section-box { background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-lg); padding: 32px; box-shadow: var(--shadow); margin: 48px 0; } .faq-section-box .faq-box { background: transparent; border: none; border-radius: 0; box-shadow: none; padding: 0; margin: 0; } /\* ── Section-specific layouts ───────────────────── \*/ /\* S02 — Split: text left, stat cards right \*/ .s02-split { display: grid; grid-template-columns: 1fr 260px; gap: 32px; align-items: start; margin-bottom: 64px; } .s02-split .post-section { margin-bottom: 0; } .s02-stats { display: flex; flex-direction: column; gap: 14px; padding-top: 8px; } .stat-card { background: var(--panel); border: 1px solid var(--line); border-radius: 12px; padding: 20px; box-shadow: var(--shadow); text-align: center; } .stat-card .stat-val { font-size: 32px; font-weight: 900; color: var(--accent); line-height: 1; margin-bottom: 6px; } .stat-card .stat-label { font-size: 12px; color: var(--muted); line-height: 1.4; } @media (max-width: 820px) { .s02-split { grid-template-columns: 1fr; } .s02-stats { flex-direction: row; flex-wrap: wrap; } .stat-card { flex: 1 1 140px; } } /\* S03 — Three pillars row \*/ .s03-pillars { margin-bottom: 64px; } .pillar-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-top: 24px; } .pillar-card { background: var(--panel); border: 1px solid var(--line); border-radius: 12px; padding: 20px 18px; box-shadow: var(--shadow); transition: border-color .15s; } .pillar-card:hover { border-color: var(--accent); } .pillar-icon { font-size: 24px; margin-bottom: 10px; display: block; } .pillar-card h4 { font-size: 14px; font-weight: 700; color: var(--text); margin: 0 0 8px; } .pillar-card p { font-size: 13px; color: var(--muted); line-height: 1.55; margin: 0; } @media (max-width: 700px) { .pillar-row { grid-template-columns: 1fr; } } /\* S04 — Pull quote accent \*/ .pull-quote { border-left: 4px solid var(--accent); margin: 28px 0; padding: 16px 22px; background: var(--accent-soft); border-radius: 0 10px 10px 0; } .pull-quote p { font-size: 17px !important; font-weight: 600; color: var(--text) !important; line-height: 1.5; margin: 0 !important; font-style: italic; } /\* S05 — Timeline steps \*/ .timeline { display: flex; flex-direction: column; gap: 0; margin: 28px 0 0; } .timeline-step { display: flex; gap: 20px; position: relative; } .timeline-step:not(:last-child)::before { content: ''; position: absolute; left: 17px; top: 36px; bottom: -16px; width: 2px; background: var(--line); } .tl-dot { width: 36px; height: 36px; border-radius: 50%; background: var(--accent); color: #fff; display: grid; place-items: center; flex: none; font-size: 16px; margin-top: 2px; box-shadow: 0 0 0 4px var(--accent-soft); } .tl-body { padding-bottom: 32px; flex: 1; } .tl-body h4 { font-size: 15px; font-weight: 700; color: var(--text); margin: 6px 0 8px; } .tl-body p { font-size: 14.5px; color: var(--text-2); line-height: 1.65; margin: 0; } /\* S06 — Layered detection grid \*/ .detection-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; margin: 28px 0 0; } .det-card { background: var(--panel); border: 1px solid var(--line); border-radius: 10px; padding: 20px; box-shadow: var(--shadow); position: relative; overflow: hidden; } .det-card::before { content: ''; position: absolute; top: 0; left: 0; width: 4px; height: 100%; background: var(--accent); border-radius: 2px 0 0 2px; } .det-card h4 { font-size: 14px; font-weight: 700; color: var(--text); margin: 0 0 8px; padding-left: 6px; } .det-card p { font-size: 13.5px; color: var(--muted); line-height: 1.55; margin: 0; padding-left: 6px; } @media (max-width: 620px) { .detection-grid { grid-template-columns: 1fr; } } /\* S07 — Outcome pill strip \*/ .outcome-strip { display: flex; gap: 12px; flex-wrap: wrap; margin: 24px 0; } .outcome-pill { display: inline-flex; align-items: center; gap: 8px; background: var(--panel); border: 1px solid var(--line); border-radius: 999px; padding: 8px 16px; font-size: 13.5px; color: var(--text); font-weight: 500; box-shadow: var(--shadow); } .outcome-pill .pill-icon { font-size: 15px; } .outcome-pill.good { border-color: #16a34a33; background: #16a34a0d; color: #16a34a; } .outcome-pill.warn { border-color: #d97706 33; background: #d977060d; color: #b45309; } /\* S08 — Comparison table \*/ .compare-table { width: 100%; border-collapse: collapse; margin: 28px 0 0; font-size: 14px; } .compare-table th { background: var(--bg-2); color: var(--muted); font-size: 11px; text-transform: uppercase; letter-spacing: .08em; padding: 10px 16px; text-align: left; border-bottom: 1px solid var(--line); } .compare-table td { padding: 12px 16px; border-bottom: 1px solid var(--line); color: var(--text-2); vertical-align: top; line-height: 1.5; } .compare-table tr:last-child td { border-bottom: none; } .compare-table .tool-name { font-weight: 600; color: var(--text); white-space: nowrap; } .compare-table .yes { color: #16a34a; font-weight: 600; } .compare-table .partial { color: #b45309; font-weight: 600; } .compare-table .no { color: var(--muted); } /\* S09 — Checklist steps \*/ .deploy-steps { display: flex; flex-direction: column; gap: 16px; margin: 28px 0 0; } .deploy-step { display: flex; gap: 16px; align-items: flex-start; background: var(--panel); border: 1px solid var(--line); border-radius: 12px; padding: 18px 20px; box-shadow: var(--shadow); transition: border-color .15s; } .deploy-step:hover { border-color: var(--accent); } .deploy-step .step-num { font-family: var(--mono); font-size: 12px; font-weight: 700; color: var(--accent); background: var(--accent-soft); border-radius: 6px; padding: 4px 8px; flex: none; margin-top: 2px; } .deploy-step h4 { font-size: 15px; font-weight: 700; color: var(--text); margin: 0 0 6px; } .deploy-step p { font-size: 14px; color: var(--text-2); line-height: 1.6; margin: 0; } /\* S10 — Objection / rebuttal accordion-style cards \*/ .objection-list { display: flex; flex-direction: column; gap: 14px; margin: 24px 0 0; } .objection-card { background: var(--panel); border: 1px solid var(--line); border-radius: 12px; overflow: hidden; box-shadow: var(--shadow); } .obj-q { display: flex; align-items: flex-start; gap: 12px; padding: 18px 20px; border-bottom: 1px solid var(--line); background: var(--bg-2); } .obj-q-icon { font-size: 16px; flex: none; margin-top: 1px; } .obj-q p { font-size: 14.5px; font-weight: 600; color: var(--text); margin: 0; line-height: 1.45; } .obj-a { padding: 16px 20px; display: flex; gap: 12px; align-items: flex-start; } .obj-a-icon { font-size: 14px; flex: none; margin-top: 2px; color: #16a34a; } .obj-a p { font-size: 14px; color: var(--text-2); line-height: 1.65; margin: 0; } /\* S11 — Evaluation checklist \*/ .eval-list { display: flex; flex-direction: column; gap: 12px; margin: 24px 0 0; } .eval-item { display: flex; gap: 14px; align-items: flex-start; padding: 16px 18px; background: var(--panel); border: 1px solid var(--line); border-radius: 10px; box-shadow: var(--shadow); } .eval-icon { width: 34px; height: 34px; border-radius: 8px; background: var(--accent-soft); color: var(--accent); display: grid; place-items: center; font-size: 16px; flex: none; } .eval-body h4 { font-size: 14px; font-weight: 700; color: var(--text); margin: 0 0 5px; } .eval-body p { font-size: 13.5px; color: var(--muted); line-height: 1.55; margin: 0; } /\* Premium Blog 3 styles \*/ .post-section { background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-lg); padding: 32px 36px; margin-bottom: 24px; scroll-margin-top: 92px; } .concept-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 18px; margin: 24px 0; } .concept-card, .surface-card, .tech-card { background: var(--bg-1); border: 1px solid var(--line); border-radius: var(--r-md); padding: 24px; transition: border-color .15s; } .concept-card:hover, .surface-card:hover, .tech-card:hover { border-color: var(--accent-line); } .concept-ic { width: 42px; height: 42px; border-radius: 10px; background: var(--accent-soft); color: var(--accent); display: grid; place-items: center; border: 1px solid var(--accent-line); margin-bottom: 14px; } .concept-card h4, .surface-card h4, .tech-card h4 { margin: 0 0 10px; font-size: 16px; } .concept-card p, .surface-card p, .tech-card p { margin: 0; font-size: 15px; color: var(--text-2); line-height: 1.65; } .attack-surface-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 18px; margin: 26px 0; } .surface-num { font-family: var(--mono); font-size: 24px; font-weight: 700; color: var(--accent); margin-bottom: 10px; } .dns-flow { display: flex; flex-direction: column; gap: 12px; margin: 28px 0; padding: 26px; background: var(--bg-1); border: 1px solid var(--line); border-radius: var(--r-lg); } .flow-step { display: flex; align-items: center; gap: 16px; } .flow-dot { width: 12px; height: 12px; border-radius: 50%; background: var(--accent); box-shadow: 0 0 0 4px var(--accent-soft); flex: none; } .flow-card { flex: 1; background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-md); padding: 16px 18px; } .flow-card h4 { margin: 0 0 4px; font-size: 15px; } .flow-card p { margin: 0; font-size: 14px; color: var(--muted); line-height: 1.55; } .flow-arrow { padding-left: 5px; color: var(--dim); font-size: 14px; } .post-quote { border-left: 3px solid var(--accent); margin: 28px 0; padding: 6px 0 6px 24px; } .post-quote p { font-size: 20px; color: var(--text); font-style: italic; margin: 0; line-height: 1.55; } .what-found { background: var(--panel); border: 1px solid var(--line); border-radius: var(--r-lg); padding: 26px; margin: 28px 0 36px; box-shadow: var(--shadow); } .what-found-head { display: flex; align-items: center; gap: 10px; margin-bottom: 14px; } .tldr-label { font-family: var(--mono); font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; background: var(--accent); color: #fff; padding: 5px 12px; border-radius: 999px; } .faq-item summary::-webkit-details-marker { display: none; } .faq-item\[open\] .faq-icon { transform: rotate(45deg); } .faq-item:not(\[open\]) .faq-icon { transform: rotate(0deg); } @media (max-width: 768px) { .concept-grid, .attack-surface-grid { grid-template-columns: 1fr; } .post-section { padding: 20px; } }

DNS filtering works by intercepting the domain lookup that happens before almost every phishing click and malware connection, checking it against threat intelligence, and simply refusing to answer if the domain is dangerous. No answer, no connection, no infection. This guide walks through exactly how that mechanism works under the hood, why it catches phishing kits and malware command-and-control traffic that other tools miss, the different filtering methods (blocklists, categories, behavioral detection, DGA scoring, typosquat matching), what a good deployment looks like in practice, and the honest limitations you should know about before you rely on it as your only line of defense.

TL;DR

### DNS Filtering in 60 Seconds

*   ✓ DNS filtering intercepts every lookup before a connection opens — stopping threats at the earliest possible point.
*   ✓ It works by resolving queries through a protective resolver that checks each domain against threat intelligence in milliseconds.
*   ✓ Phishing sites, malware C2 servers, and lookalike domains are blocked before the browser ever loads a byte.
*   ✓ Unlike endpoint tools, DNS filtering covers every device on a network with zero software to install.
*   ✓ It complements firewalls and EDR — it doesn't replace them — but it catches threats earlier.

Key Takeaways

### What You'll Learn

*   **The Mechanism:** Exactly how a filtering resolver intercepts and blocks a domain query before a connection ever opens.
*   **Phishing Defence:** Why DNS is the single best choke point to stop phishing — before the page even renders.
*   **Malware C2 Blocking:** How filtering cuts off malware's ability to call home to command-and-control servers.
*   **Deployment:** A 6-step framework for rolling out filtering without disrupting your team's legitimate work.
*   **Evaluation:** The five questions to ask any DNS filtering provider before signing a contract.

01

## The Split Second Before Everything Goes Wrong
